...
# 	backupMode = ".backup"
backupMode = ".backup"
for line in fileinput.input(inplace=1, backup=backupMode): # Only problem: if you do *.html, it treats the second HTML file as sys.argv[2]--that is, as the mode, not a file!
